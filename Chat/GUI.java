...
public class GUI {
    ...
    public void createClientInterface() {
        ...
        Object[] texts = {_message, _ip, _clientPort, _clientName};
        JOptionPane.showMessageDialog(null, texts);
    }
    ...
    public void createChatScreen(ObjectOutputStream pClient, Socket pClientSocket) {
        ...
        _buttonSendListener = new ButtonSendListener(pClient, _textMessage, _clientName);
        ...
        _text.setBorder(BorderFactory.createEtchedBorder(Color.GRAY, Color.GRAY));
        _textMessage.setBorder(BorderFactory.createEtchedBorder(Color.GRAY, Color.GRAY));
        _frame = new JFrame();
        _frame.setTitle(_clientName.getText());
        _frame.setContentPane(_content);
        _frame.setLocationRelativeTo(null);
        _frame.setResizable(false);
        _frame.setSize(275, 350);
